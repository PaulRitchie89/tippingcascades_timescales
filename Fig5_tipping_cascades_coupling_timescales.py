...
for j in range(len(bs)):
    ...
    ax2 = fig2.add_subplot(2,3,j+2, projection='3d')
...
fig2.text(0.55,0.93,'$b$ = '+str(bs[0]))
fig2.text(0.88,0.93,'$b$ = '+str(bs[1]))
fig2.text(0.22,0.43,'$b$ = '+str(bs[2]))
fig2.text(0.55,0.43,'$b$ = '+str(bs[3]))
fig2.text(0.88,0.43,'$b$ = '+str(bs[4]))

ax0.spines['right'].set_visible(False)
ax0.spines['top'].set_visible(False)

# fig2.savefig('../Figures/Linear_coupling/Cascade_tipping_lin_coupling_lambda_M_3dbif_arrows_speed.pdf', format='pdf', dpi=800)