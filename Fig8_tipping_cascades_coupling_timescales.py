...
data = np.genfromtxt('../../../XPPAut_scripts_data/Data/Cascade_loc_coupling_2par_lambda_b_v1.dat', dtype=float, delimiter=' ')
data2 = np.genfromtxt('../../../XPPAut_scripts_data/Data/Cascade_loc_coupling_2par_lambda_b_v2.dat', dtype=float, delimiter=' ')
lamb=data[:,0]
b=data[:,1]
lamb2=data2[:,0]
b2=data2[:,1]
